...
export function App() {
  ...
  if (isHome) {
    return (
      <div className="h-screen w-screen overflow-hidden bg-ctp-base text-ctp-text flex flex-col">
        ...
        <div className="flex-1 min-h-0 grid grid-cols-[68px_1fr]">
          <ProjectRail />
          <Dashboard />
        </div>
      </div>
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-ctp-base text-ctp-text flex flex-col">
      ...
      <GitBanner />
      {/* Main content grid */}
      <div className={`flex-1 min-h-0 grid ${isFullWidth ? 'grid-cols-[68px_200px_1fr]' : 'grid-cols-[68px_200px_280px_1fr]'}`}>
        <ProjectRail />
        <ExplorerRail />
