      ...
      <div className="flex items-center justify-between">
        ...
        >
          <svg
            ...
            className={`text-ctp-subtext0 transition-transform ${expanded ? 'rotate-90' : ''}`}
          >
            <path d="M9 18l6-6-6-6" />
          </svg>
          <h3 className="text-xs text-ctp-subtext0 uppercase tracking-wider group-hover:text-ctp-text transition-colors">
